...
class TPCallback extends TPDigiBase
{
    ...
    public $method_mapping = array(
        "IDE" => \DigiWalletCore::METHOD_IDEAL,
        "MRC" => \DigiWalletCore::METHOD_MRCASH,
        "DEB" => \DigiWalletCore::METHOD_SOFORT,
        "WAL" => \DigiWalletCore::METHOD_PAYSAFE,
        "CC" => \DigiWalletCore::METHOD_CREDIT_CARD,
        "AFP" => \DigiWalletCore::METHOD_AFTERPAY,
        "BW" => \DigiWalletCore::METHOD_BANKWIRE,
        "PYP" => \DigiWalletCore::METHOD_PAYPAL,
        "GIP" => \DigiWalletCore::METHOD_GIRO,
        "EPS" => \DigiWalletCore::METHOD_EPS
    );
