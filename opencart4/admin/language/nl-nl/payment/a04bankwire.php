<?php
// Heading
$_['heading_title'] = 'DigiWallet Bankwire - Overschrijvingen';

// Text
$_['text_payment'] = 'Betaling';
$_['text_success'] = 'Gelukt: de DigiWallet instellingen zijn gewijzigd!';
$_['text_edit'] = 'Bewerk DigiWallet ' . $_['heading_title'];
$_['text_a04bankwire'] = '<a href="https://www.digiwallet.nl/signup?p_actiecode=YM3R2A" target="_blank"><img src="../extension/digiwallet/admin/view/images//bankwire.png" alt="Bankwire via DigiWallet" title="Bankwire via DigiWallet" style="border: none;" /></a>';
...
$_['error_rtlo'] = 'DigiWallet Outletcode (rtlo) is verplicht!';
