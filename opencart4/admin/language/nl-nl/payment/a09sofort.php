<?php
// Heading
$_['heading_title'] = 'DigiWallet Sofort';

// Text
$_['text_payment'] = 'Betaling';
$_['text_success'] = 'Gelukt: de DigiWallet instellingen zijn gewijzigd!';
$_['text_edit'] = 'Bewerk DigiWallet ' . $_['heading_title'];
$_['text_a09sofort'] = '<a href="https://www.digiwallet.nl/signup?p_actiecode=YM3R2A" target="_blank"><img src="../extension/digiwallet/admin/view/images//sofort.png" alt="Sofort via DigiWallet" title="Sofort via DigiWallet" style="border: none;" /></a>';
